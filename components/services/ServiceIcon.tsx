...
export default function ServiceIcon({ slug, className = "w-8 h-8" }: Props) {
  const common = { className, fill: "none" as const, stroke: "currentColor", viewBox: "0 0 24 24" };
